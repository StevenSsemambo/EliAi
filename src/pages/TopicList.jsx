...
const SUBJECT_FILES = {
  mathematics: {
    s1: ['algebra', 'geometry', 'linear_equations', 'mensuration', 'number_theory', 'numbers', 'ratio_indices', 'sets', 'statistics_intro'],
    s2: ['coordinate_geometry', 'logarithms', 'quadratic', 'simultaneous', 'statistics', 'trigonometry', 'vectors_2d', 'vectors_intro'],
    s3: ['coordinate_sequences', 'differentiation', 'functions', 'integration', 'matrices_probability'],
    s4: ['calculus', 'financial_maths', 'loci_construction', 'permcomb', 'trigonometry_advanced', 'vectors'],
  ...
  physics: {
    s1: ['density_flotation', 'energy', 'forces', 'light', 'measurement', 'properties_matter'],
    s2: ['current_electricity', 'electronics', 'magnetism_heat', 'sound', 'waves_electricity'],
    s3: ['electromagnetic', 'kinematics', 'motion_kinematics', 'pressure_fluids', 'radioactivity'],
    s4: ['circular_gravitation', 'electricity_detail', 'electronics', 'optics_full'],
    s5: ['mechanics_advanced', 'nuclear_physics', 'optics_full', 'thermal_physics', 'waves_optics'],
    s6: ['astrophysics', 'modern_physics', 'particle_physics', 'quantum_mechanics', 'relativity'],
  },
  biology: {
    s1: ['cells', 'classification', 'diffusion_osmosis', 'photosynthesis_respiration'],
    s2: ['digestion_ecology', 'nervous_system', 'nutrition', 'reproduction', 'transport'],
    s3: ['ecology', 'excretion', 'genetics', 'hormones_homeostasis', 'reproduction'],
    s4: ['cell_division', 'coordination', 'disease_health', 'ecology', 'evolution_immunity'],
    s5: ['biochemistry', 'cell_biology_advanced', 'ecology_advanced', 'genetics_advanced', 'microbiology'],
    s6: ['developmental_biology', 'immunology', 'molecular_biology'],
  },
  chemistry: {
    s1: ['atoms', 'bonding', 'matter', 'water'],
    s2: ['acids_periodic', 'energy_changes', 'gases_solutions', 'mole_calculations', 'reactions_metals'],
    s3: ['electrochemistry', 'gases', 'organic_rates', 'stoichiometry'],
    s4: ['chemical_analysis', 'organic_chemistry', 'thermochemistry'],
    s5: ['advanced_organic', 'equilibria', 'equilibrium', 'spectroscopy', 'transition_metals'],
    s6: ['green_chemistry', 'industrial_chemistry', 'pharmaceuticals', 'polymers'],
  },
}
