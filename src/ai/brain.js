...
const MISTAKE_PATTERNS = [
  { id: 'calculation',  label: 'Calculation Errors',    advice: 'Write out each step fully - don\'t skip arithmetic. Check your working twice.',      keywords: ['calculate','solve','find the value','compute','evaluate','simplify'] },
  { id: 'concept',      label: 'Conceptual Gaps',       advice: 'Re-read the lesson explanation before attempting questions. Use the AI tutor to ask "what is X?"', keywords: ['what is','define','explain','describe','which of','what does'] },
  { id: 'application',  label: 'Application Problems',  advice: 'Identify what is given and what is asked first. Draw a diagram or list known values before solving.', keywords: ['apply','use','given that','a student','a car','a plant','if x'] },
  { id: 'memory',       label: 'Recall & Memory',       advice: 'Use the Flashcards feature daily. Try to recall definitions before checking the answer.',       keywords: ['name','list','state','identify','recall','what are the'] },
  { id: 'diagram',      label: 'Diagram/Visual',        advice: 'Practice drawing and labelling diagrams from memory. Check the lesson diagrams section.',          keywords: ['diagram','label','draw','show','figure','graph','chart'] },
]
...
export async function analyseStudent(studentId) {
  ...
  // -- Exam predictor: score UNEB weight x weakness -------------
